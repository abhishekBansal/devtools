        ...
        <Content style={{ 
          ...
          <div style={{ 
            ...
            <Routes>
              ...
              <Route path="/tools/base64-encoder-decoder" element={<Base64Page />} />
              <Route path="/tools/json-validator-formatter" element={<JsonPage />} />
              <Route path="/tools/uuid-generator" element={<UuidPage />} />
              <Route path="/tools/hex-text-converter" element={<HexPage />} />
              <Route path="/tools/timestamp-converter" element={<TimestampPage />} />
              <Route path="/tools/cron-expression-parser" element={<CronPage />} />
              <Route path="/tools/string-analyzer" element={<StringAnalyzerTool />} />
              <Route path="/tools/string-case-converter" element={<StringCaseConverterTool />} />
